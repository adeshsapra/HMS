          ...
          <Tabs value="general">
            ...
            <TabsBody>
              ...
              <TabPanel value="email">
                ...
                <div className="space-y-4">
                  <Input label="SMTP Host" crossOrigin={undefined} />
                  <Input label="SMTP Port" type="number" crossOrigin={undefined} />
                  <Input label="SMTP Username" crossOrigin={undefined} />
                  <Input label="SMTP Password" type="password" crossOrigin={undefined} />
              ...
              <TabPanel value="sms">
                ...
                <div className="space-y-4">
                  <Input label="SMS Gateway API Key" crossOrigin={undefined} />
                  <Input label="SMS Gateway URL" crossOrigin={undefined} />
              ...
              <TabPanel value="payment">
                ...
                <div className="space-y-4">
                  ...
                  <Input label="API Key" crossOrigin={undefined} />
                  <Input label="Secret Key" type="password" crossOrigin={undefined} />
