...
import { Card, CardBody, CardHeader, Button, Typography, Dialog, DialogHeader, DialogBody, DialogFooter } from "@material-tailwind/react";
import { PhotoIcon, PlusIcon, XMarkIcon, TrashIcon, PencilIcon, EyeIcon } from "@heroicons/react/24/outline";
import { FormModal, DeleteConfirmModal, FormField } from "@/components";
...
export default function Gallery(): JSX.Element {
  ...
  const handleDelete = (image: GalleryImage): void => {
    setSelectedImage(image);
  ...
  const handleView = (image: GalleryImage): void => {
    setSelectedImage(image);
