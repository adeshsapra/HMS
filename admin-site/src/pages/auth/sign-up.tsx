      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-arovis-cyan to-arovis-blue rounded-3xl transform -rotate-3"></div>
            <div className="relative bg-white rounded-3xl p-8 shadow-2xl">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-arovis-blue/10 rounded-full flex items-center justify-center">
                    <UserPlusIcon className="h-6 w-6 text-arovis-blue" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-arovis-cyan/20 rounded-full flex items-center justify-center">
                    <BuildingOfficeIcon className="h-6 w-6 text-arovis-blue" />
                  </div>
                  <div>
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-start">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 text-arovis-blue border-gray-300 rounded focus:ring-arovis-blue"
              />
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
                I agree to the{" "}
                <Link to="#" className="text-arovis-blue hover:text-arovis-navy font-medium">
            ...
            <Typography variant="small" className="text-center text-gray-600 mt-6">
              ...
              <Link to="/auth/sign-in" className="text-arovis-blue hover:text-arovis-navy font-semibold">
                Sign In
              </Link>
            </Typography>
          </form>
