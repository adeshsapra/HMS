...
<body>
                ...
                <div class="service-details">
                    <div class="service-row">
                        <div class="service-icon">
                            <i class="bi ${
                              selectedService?.icon || "bi-heart-pulse-fill"
            ...
            <div class="receipt-section">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="value">${
                          bookingData.patientName || "N/A"
                        }</div>
                    </div>
                    <div class="info-item">
                        <label>Age & Gender</label>
                        <div class="value">${bookingData.age || "N/A"} Years, ${
  ...
  const downloadReceipt = () => {
    ...
    link.download = `Booking-Receipt-${
      bookingData.patientName || "Receipt"
  ...
  return (
    <div className="home-care-container container py-3 py-md-5">
                      ...
                      {homeCareServices
                        ...
                        .map((service: any) => (
                          <div key={service.id} className="col-md-6">
                            <div
                              className={`p-3 border rounded-3 cursor-pointer h-100 transition-all ${
                ...
                <div className="animate-fade-in">
                  ...
                  <div className="row g-2 g-md-3">
                    <div className="col-12">
                      <div
                        className={`p-3 p-md-3 border rounded-3 cursor-pointer mb-2 mb-md-3 ${
                    ...
                    {homeCareProfessionals.length === 0 ? (
                      ...
                      homeCareProfessionals.map((prof: any) => (
                        <div key={prof.id} className="col-12 col-md-6">
                          <div
                            className={`p-3 p-md-3 border rounded-3 cursor-pointer h-100 ${
                              bookingData.professionalId === prof.id.toString()
                                ? "border-primary bg-light"
                                : ""
                            }`}
                            onClick={() =>
                ...
                <div className="card border-0 shadow-sm rounded-4 h-100 bg-white p-3 p-md-4">
                  ...
                  <div className="row g-2 g-md-3 mb-3 mb-md-4">
                    <div className="col-sm-6">
                      <div
                        className={`payment-method-chip p-3 rounded-4 border text-center cursor-pointer transition-all ${
                          paymentMethod === "card"
                            ? "active shadow-lg"
                      ...
                      >
                        <i
                          className={`bi bi-credit-card-2-back fs-2 mb-2 d-block ${
                            paymentMethod === "card"
                              ? "text-white"
                              : "text-primary"
                          }`}
                        ></i>
                        <span
                          className={`fw-bold small d-block ${
                            paymentMethod === "card"
                              ? "text-white"
                              : "text-dark"
                          }`}
                    ...
                    <div className="col-sm-6">
                      ...
                      >
                        <i
                          className={`bi bi-qr-code fs-2 mb-2 d-block ${
                            paymentMethod === "upi"
                              ? "text-white"
                              : "text-primary"
                          }`}
                        ...
                        <span
                          className={`fw-bold small d-block ${
                            paymentMethod === "upi" ? "text-white" : "text-dark"
                          }`}
                        >
                          Instant UPI QR
                        </span>
